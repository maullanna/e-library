...
$menu[] = array(__('Biblio Data Export'), MWB.'bibliography/export.php', __('Export Bibliographic Data To XLSX format'));
$menu[] = array(__('Biblio Data Import'), MWB.'bibliography/import.php', __('Import Data to Bibliographic Database from XLSX file'));
