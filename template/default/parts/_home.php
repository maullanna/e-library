    ...
    <?php if ($sysconf['template']['classic_top_reader']) : ?>
        <section class="mt-5 bg-white">
            <div class="container py-5">
                <h4 class="mb-4">
                    <?php echo __('Pengunjung terbaik kami'); ?>
                    <br>
                    <small class="subtitle-section"><?php echo __('Pengunjung terbaik kami ada di sini. Nama dan foto Anda juga bisa muncul di sini. Rajin-rajinlah berkunjung dan membaca.'); ?></small>
                </h4>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <iframe class="embed-responsive"
                        src="https://www.google.com/maps?q=Akademi%20Komunitas%20Toyota%20Indonesia%2C%20Jl.%20Trans%20Heksa%20No.01%2C%20Desa%20Margamulya%2C%20Kec.%20Telukjambe%20Barat%2C%20Kab.%20Karawang%2C%20Jawa%20Barat%2041361&output=embed"
                        height="420" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
                <div class="col-md-6 pt-8 md:pt-0">
                    <h4>Akademi Komunitas Toyota Indonesia</h4>
                    <p>
                        Jl. Trans Heksa No.01 Desa Margamulya, Kec. Telukjambe Barat, Kab. Karawang - Jawa Barat 41361<br>
                        Email : tia.admin@toyota.co.id
                    </p>
