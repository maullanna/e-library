    ...
    <div class="container">
        <div class="row py-4">
            ...
            <div class="col-md-5 pt-8 md:pt-0">
                <h4 class="mb-4"><?= __('Tentang Kami'); ?></h4>
                <p>
                    Perpustakaan Digital AKTI hadir sebagai pusat informasi dan layanan literasi untuk mendukung kegiatan belajar, penelitian, dan pengembangan pengetahuan civitas Akademi Komunitas Toyota Indonesia.
                </p>
            </div>
            <div class="col-md-4 pt-8 md:pt-0">
                <h4 class="mb-4"><?= __('Cari'); ?></h4>
                <div class="mb-2"><?= __('Masukkan satu atau lebih kata kunci dari judul, pengarang, atau subjek'); ?></div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary" type="submit" value="search" name="search"
                                    id="button-addon2"><?= __('Cari Koleksi'); ?>
                            </button>
                        </div>
                    </div>
                </form>
                <hr>
                <div class="mb-1">Jl. Trans Heksa No.01 Desa Margamulya, Kec. Telukjambe Barat, Kab. Karawang - Jawa Barat 41361</div>
                <div>Email : tia.admin@toyota.co.id</div>
            </div>
        </div>
        <hr>
        <div class="flex font-thin text-sm">
            <p class="flex-1">&copy; <?php echo date('Y'); ?> &mdash; AKTI</p>
            <div class="flex-1 text-right text-grey"><?= __('Perpustakaan Digital AKTI'); ?></div>
        </div>
    </div>
</footer>
