...
final class Memory
{
    ...
    /**
     * Update locale from config after database settings are loaded
     *
     * @return void
     */
    public function updateLocaleFromConfig(): void
    {
        global $sysconf;
        $this->locale = $sysconf['default_lang'] ?? 'en_US';

        
        // Reload dictionary with new locale
